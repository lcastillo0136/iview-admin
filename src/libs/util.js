...
export const setToken = (token, expiration_date) => {
  Cookies.set(TOKEN_KEY, token, { expires: expiration_date || cookieExpires || 1 })
}
...
export const showTitle = (item, vm) => {
  ...
  if (useI18n) {
    ...
    else title = vm.$t((item.meta && item.meta.title) || item.name)
